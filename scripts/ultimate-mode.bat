...
:: ---------- PowerShell (aguarda cada um) ----------
powershell -ExecutionPolicy Bypass -File "%~dp0servicos-do-windows.ps1"
powershell -ExecutionPolicy Bypass -File "%~dp0inicializacao.ps1"
powershell -ExecutionPolicy Bypass -File "%~dp0registro-do-sistema.ps1"
